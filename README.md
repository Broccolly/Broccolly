...
## Who am I?
- I am a physicist-turned-games programmer using C++ and other languages to a high standard to create game engine functionality and gameplay experiences.
...
<p align="center">
  <a href="https://broccolly.github.io">Portfolio</a>
  ·
...
- Professional experience within Agile projects using Azure DevOps, Jira, git and Perforce.
...
- Technical writing
- Physics teaching at undergraduate level
...
| --- | --- | --- |
| [Nutmeg!](https://store.steampowered.com/app/3590560/NUTMEG_A_Nostalgic_Deckbuilding_Football_Manager/)<br>(Sumo Digital, 2026) | An 80's nostalgia-filled football management card game | Built a system to create UI elements embedded on 3D objects.<br><br>Managed the data pipeline for players and teams.<br>Created the mathematical algorithms that generate match outcomes |
| [Snake Party](https://mcvuk.com/business-news/from-the-industry-sheffield-wednesday-and-game-developer-sumo-digital-create-a-halftime-hit/)<br>(Sumo Digital, 2025) | A project developed for Sheffield Wednesday Football Club inspired by [Snake Pass](https://store.steampowered.com/app/544330/Snake_Pass/) | I wrote a C++ physics engine from scratch to allow complex snake behaviour and interaction with the environment.|
...
## Academic Work
My academic work focused on developing computational techniques to better understand the transition to turbulence in fusion reactors. I was exploring the role recurrent structures such as oscillations and soliton-like waves play in this transition. I predominantly worked in FORTRAN, running high performance code on supercomputers and large computer clusters.

I took additional modules in High Performance Computing (HPC) and Machine Learning.
